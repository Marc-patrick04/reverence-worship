            ...
            <section class="form-panel flex items-center justify-center p-5 sm:p-7 lg:p-8">
                <div class="w-full max-w-md">
                    <div class="mb-5 flex items-center justify-between gap-4">
                        ...
                        <a href="{{ route('home') }}" class="auth-link inline-flex items-center gap-2 rounded-full border border-green-800/20 bg-white/60 px-3 py-2 text-xs font-semibold hover:bg-white transition">

<!-- ============================================ -->
<!-- PAYMENT MODALS - Finance Module              -->
<!-- ============================================ -->

<!-- View Payment Details Modal -->
<div id="viewPaymentModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center modal-overlay" role="dialog" aria-modal="true" aria-labelledby="viewPaymentModalTitle">
    <div class="relative mx-auto p-4 border w-full max-w-md shadow-2xl rounded-lg bg-white max-h-[90vh] flex flex-col">
        <div class="flex justify-between items-center pb-3 border-b">
            <h3 id="viewPaymentModalTitle" class="text-lg font-bold text-gray-800">Payment Details</h3>
            <button onclick="window.paymentsManager.closeModal('viewPaymentModal')" class="text-gray-400 hover:text-gray-600 transition" aria-label="Close modal">
                <i class="fas fa-times text-xl" aria-hidden="true"></i>
            </button>
        </div>
        <div id="viewPaymentContent" class="mt-3 space-y-3 overflow-y-auto flex-1">
            <!-- Content loaded dynamically -->
        </div>
        <div class="flex justify-end mt-4 pt-3 border-t">
            <button onclick="window.paymentsManager.closeModal('viewPaymentModal')" class="h-8 px-3 py-0 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs transition">
                Close
            </button>
        </div>
    </div>
...
<div id="editPaymentModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center modal-overlay" role="dialog" aria-modal="true" aria-labelledby="editPaymentModalTitle">
    <div class="relative mx-auto p-4 border w-full max-w-md shadow-2xl rounded-lg bg-white max-h-[90vh] flex flex-col">
        <div class="flex justify-between items-center pb-3 border-b">
            <h3 id="editPaymentModalTitle" class="text-lg font-bold text-gray-800">Edit Payment</h3>
            <button onclick="window.paymentsManager.closeModal('editPaymentModal')" class="text-gray-400 hover:text-gray-600 transition" aria-label="Close modal">
                <i class="fas fa-times text-xl" aria-hidden="true"></i>
            </button>
        </div>
        <div class="mt-3 overflow-y-auto flex-1">
            ...
            <div class="bg-blue-50 rounded-lg p-3 mb-3">
                <h4 class="text-sm font-semibold text-gray-800 mb-2">Current Payment</h4>
                <div class="grid grid-cols-2 gap-2 text-xs">
                    <div>
                        <span class="text-gray-500">Amount:</span> 
                        <span class="font-medium text-green-600" id="currentPaymentAmount">RWF 0</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Term:</span> 
                        <span class="font-medium" id="currentPaymentTerm">-</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Method:</span> 
                        <span class="font-medium capitalize" id="currentPaymentMethod">-</span>
                    </div>
                    <div>
                        <span class="text-gray-500">Date:</span> 
                        <span class="font-medium" id="currentPaymentDate">-</span>
                    </div>
                </div>
            </div>

            <form id="editPaymentForm" onsubmit="window.paymentsManager.submitEditPayment(event)" class="space-y-3">
                <input type="hidden" id="editPaymentId">
                <input type="hidden" id="editPaymentUserId">
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Member</label>
                    <span id="editPaymentMemberName" class="block h-8 px-3 py-1.5 bg-gray-100 rounded-lg text-sm text-gray-800 font-medium"></span>
                </div>
                
                <div>
                    <label for="editPaymentYearDisplay" class="block text-sm font-medium text-gray-700 mb-1">Year</label>
                    <span id="editPaymentYearDisplay" class="block h-8 px-3 py-1.5 bg-gray-100 rounded-lg text-sm text-gray-800 font-medium"></span>
                ...
                <div>
                    ...
                    <select id="editPaymentTerm" class="w-full h-8 px-3 py-0 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" required aria-required="true">
                ...
                <div>
                    ...
                    <select id="editPaymentMethod" class="w-full h-8 px-3 py-0 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <textarea id="editPaymentNotes" rows="2" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Add notes about this change..."></textarea>
                </div>
            </form>
        </div>
        <div class="flex justify-end gap-2 mt-4 pt-3 border-t">
            <button onclick="window.paymentsManager.closeModal('editPaymentModal')" class="h-8 px-3 py-0 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg text-xs transition">
                Cancel
            </button>
            <button type="submit" form="editPaymentForm" id="submitEditPaymentBtn" class="h-8 px-3 py-0 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs transition flex items-center gap-1.5">
...
<!-- Record Payment Modal (from Contributions) -->
...
<!-- Set Annual Contribution Modal (from Contributions) -->
...
<!-- Edit Contribution Modal (from Contributions) -->
...
<!-- View Details Modal (from Contributions) -->

...
class ContributionController extends Controller
{
    public function index()
    {
        ...
        return view('modules.finance.index', compact('numberOfTerms', 'termPercentages', 'users', 'contributions','families'));
    }
    ...
    // ==================== CONTRIBUTION METHODS (renamed to avoid conflict) ====================
  ...
  public function filterMemberContributions(Request $request)
{
    try {
        ...
        $familyId = $request->family_id; // Add family filter
        ...
        $query = DB::table('users')
            ...
            // Join with family_members to get family info
        ...
        return response()->json(['success' => true, 'contributions' => $result]);
    } catch (\Exception $e) {
    ...
    public function storePayment(Request $request)
    {
        try {
            ...
            return response()->json(['success' => true, 'message' => 'Payment recorded successfully', 'id' => $id]);
        } catch (\Exception $e) {

        ...
        try {
            ...
            if (isset($data['questions']) && is_array($data['questions'])) {
                foreach ($data['questions'] as $q) {
                    ...
                    // Handle correct answers for quizzes
                    ...
                    if (isset($q['correctAnswers']) && is_array($q['correctAnswers'])) {
                        ...
                        if (!empty($cleanAnswers)) $cleanQuestion['correctAnswers'] = array_values($cleanAnswers);
                    }
        ...
        try {
            ...
            if (isset($data['questions']) && is_array($data['questions'])) {
                foreach ($data['questions'] as $q) {
                    ...
                    if (isset($q['min'])) $cleanQuestion['min'] = (int)$q['min'];
                    if (isset($q['max'])) $cleanQuestion['max'] = (int)$q['max'];
                    if (isset($q['correctAnswer']) && !empty($q['correctAnswer'])) $cleanQuestion['correctAnswer'] = $q['correctAnswer'];

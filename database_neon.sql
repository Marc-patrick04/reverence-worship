-- Neon-safe schema for Reverence Worship
-- Generated from database_dep.sql by removing DROP/CREATE DATABASE and \c commands.
-- Run this inside the Neon database you already created.

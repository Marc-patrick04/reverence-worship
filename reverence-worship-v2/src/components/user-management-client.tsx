        ...
        <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-xl bg-white shadow-xl">
            ...
            <form action={importAction} className="space-y-4 p-5">
              ...
              <div>
                <label className="mb-1 block text-xs font-semibold text-gray-700">Excel or CSV file</label>
                <input
                  name="file"
                  type="file"
                ...
                />
                <p className="mt-1 text-xs text-gray-500">You can upload .xlsx, CSV, or tab-separated export files.</p>
              </div>
